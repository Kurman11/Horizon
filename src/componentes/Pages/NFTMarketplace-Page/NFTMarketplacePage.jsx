    ...
    <section className="section">
      <div className={Style['advertisement']}>
        <div className={Style['advertisement-div']}>
          <h2 className={Style['advertisement-text']}>DisCover, collect, and <br />sell extraordinary NFTs</h2>
          <div className={Style['advertisement-sub-text']}>Enter in this creative world, Discover now the <br /> latest NFTs or start creating your own!</div>
          <div>
            <button type="button" className={button === "discover" ? Style['on'] : ""} onClick={() => handClick("discover")}>Discover now</button>
            <button type="button" className={button === "watch" ? Style['on'] : ""} onClick={() => handClick("watch")}>Watch video</button>
          </div>
        </div>
      </div>
